    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>DiningView — Investor Report</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.cellHeaderRight}>Revenue (₫)</Text>
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.kpiRow}>
            ...
            <Text style={styles.kpiValue}>₫{data.kpis.avg_spend.toFixed(0)}</Text>
          </View>
          <View style={styles.kpiRow}>
        ...
        <Text style={styles.footer}>
          Generated by DiningView | {new Date().toISOString().split('T')[0]}
        </Text>
      </Page>
    </Document>
  )
